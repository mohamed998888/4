...
ownerID = int("6561974387") #ايدي الادمن 
api_hash = "aac06d2fddb5c3e0c1c8aa59a94c94aa" #ايبي هاش 
api_id = 24030976 #ايبي ايدي
token = "6972167779:AAGBweg8rJY4V6pYFiTjMz_3D8FzuYVwNZ4" #توكن البوت


bot = Client(
  'bot'+token.split(":")[0],
  24030976, #ايبي ايدي
 'aac06d2fddb5c3e0c1c8aa59a94c94aa', #ايبي هاش
